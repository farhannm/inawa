        ...
        <div class="container-fixed flex items-center justify-between flex-wrap gap-3">
            <div class="flex items-center flex-wrap gap-1 lg:gap-5">
                ...
                <div class="flex items-center flex-wrap gap-1 text-sm">
                    ...
                    <a class="text-gray-700 hover:text-primary" href="{{ route('viewTipe') }}">
                        Tipe Kamar
                    </a>
                </div>
            </div>
            ...
            <div class="card card-grid min-w-full">
                <div class="card-header flex-wrap gap-2">
                    <h3 class="card-title font-medium text-sm">
                        Showing {{ $tipes->count() }} of {{ $tipes->total() }} tipe
                    </h3>
                    <div class="flex flex-wrap gap-2 lg:gap-5">
                        <div class="flex">
                            <label class="input input-sm">
                                ...
                                <input placeholder="Cari tipe..." type="text" value="">
                                </input>
                            </label>
                        </div>
                    ...
                    <div data-datatable="true" >
                        ...
                        <div class="card-footer justify-center md:justify-between flex-col md:flex-row gap-5 text-gray-600 text-2sm font-medium">
                            ...
                            <div class="flex items-center gap-4 order-1 md:order-2">
                                <span>
                                    Showing {{ $tipes->firstItem() }} to {{ $tipes->lastItem() }} of {{ $tipes->total() }} users
                                </span>
                                <div class="pagination">
                                    {{ $tipes->appends(request()->query())->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
